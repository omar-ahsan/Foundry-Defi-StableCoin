...
contract DSCEngine is ReentrancyGuard {
     ...
     * This function burns DSC abd redeems underlying collateral in one transaction
     */
     ...
     * For example, if thep rice of the collateral plummeted before anyone could be liquidated
     *
     * Follows CEI: CHECKS, EFFECTS, INTERATIONS
     */
    function liquidate(
        address collateral,
        address user,
